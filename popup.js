...
(function(){
  chrome.storage.local.get(null, function(storage){
    var allFields, makeDiv, makeField, makeContent, makeFields, addForm, saveForm, saveAndFillForm;
    ...
    addForm = function(container){
      ...
      return container.appendChild((ref$ = document.createElement('button'), ref$.innerHTML = 'Save and fill button', ref$.onclick = saveAndFillForm, ref$));
    };
